...
<?php include 'common/connection-db.php'; ?>
...
<div class="row" style="width: 550px; margin: 0 auto;">
    ...
    <?php endif;?>
    <form action="register.php" method="POST" id="registration" class="form-horizontal" role="form" enctype="multipart/form-data">
        <div class="form-group">
            <label for="fristname" class="col-lg-4 control-label">First Name</label>
            <div class="col-lg-8">
                <input type="text" name="firstname"  class="form-control" id="fristname" placeholder="First Name">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
                <input type="text" id="datepicker" name="datepicker" class="form-control"  placeholder="Date of birth" >
            </div>
        </div>
        <div class="form-group">
        ...
        <hr />
        <div class="form-group">
            <label for="agree" class="col-lg-4 control-label">Agree </label>
            <div class="col-lg-8">
                <div class="checkbox">
                    <label>
