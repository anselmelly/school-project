...
<?php endif; ?>
<h2 style="margin: 0 0 0 15px;">Exam <a class="pull-right" href="add-exam.php"><button type="button" class="btn btn-primary navbar-btn">Add Exam</button></a></h2>
<hr>
...
<script>
    $(document).ready(function() {
        ...
        $('#sub_list').dataTable( {
            ...
            "bProcessing": true,
            "sAjaxSource": 'exam-list-view.php'
        } );   
    } );
</script>
