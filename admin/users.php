...
<?php endif;?>
<h2 style="margin: 0 0 0 15px;">Users <a class="pull-right" href="registration-form.php"><button type="button" class="btn btn-primary navbar-btn">Add User</button></a></h2>
<hr>
