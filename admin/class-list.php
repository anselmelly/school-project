...
<?php endif;?>
<h2 style="margin: 0 0 0 15px;">Subject <a class="pull-right" href="add-class.php"><button type="button" class="btn btn-primary navbar-btn">Add Class</button></a></h2>
<hr>
...
<script>
    $(document).ready(function() {
        ...
        $('#sub_list').dataTable( {
            ...
            "bProcessing": true,
            "sAjaxSource": 'class-list-view.php'
        } );   
    } );
</script>
